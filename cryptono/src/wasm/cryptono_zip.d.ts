...
export interface InitOutput {
    ...
    readonly compress_brotli: (a: number, b: number, c: number) => [number, number];
    readonly compress_deflate: (a: number, b: number) => [number, number];
    readonly decompress_brotli: (a: number, b: number) => [number, number];
    readonly decompress_deflate: (a: number, b: number) => [number, number];
