/* @ts-self-types="./cryptono_audit.d.ts" */

/**
 * @param {string} payload
 * @returns {any}
 */
export function perform_local_audit(payload) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(payload, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.perform_local_audit(retptr, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('cryptono_audit_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
